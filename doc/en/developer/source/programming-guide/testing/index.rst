...
The tests will call the REST API and the OGC services to test functionalities such as creating a workspace and publishing a PostGIS or an ImageMosaic layer.
